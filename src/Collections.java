...
public class Collections {
    public static void main(String[] args) {
        ...
        usernames.put("David", "David");
        usernames.put("Tristian", "Tristian");
        ...
        //   a. "Vivian" -> "viviancan"
        //   b. "Casey" -> "XpenguinX"
        usernames.putIfAbsent("David", "David");
        ...
        /* No only "David" object was added because the "Casey" object already existed */
        ...
        usernames.replace("David", "DavidAwesome");
        System.out.println(usernames);
